...
//This script came from one of Gareth's workshop

namespace UnityEngine.EventSystems
{
    [AddComponentMenu("Event/Gaz Standalone Input Module")]
    public class gazStandaloneInputModule : PointerInputModule
    {
        ...
        protected gazStandaloneInputModule()
        { }
